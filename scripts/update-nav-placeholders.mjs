...
for (const file of files) {
  ...
  const contentWithoutDoctype = doctypeMatch ? originalContent.slice(doctype.length) : originalContent;

  const $ = cheerio.load(contentWithoutDoctype, { decodeEntities: false });
